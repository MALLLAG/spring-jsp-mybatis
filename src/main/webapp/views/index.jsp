...
<div id ="aaa"class="content">
    	...
    	<div style="float: right; margin-top: 1%;" >
	        ...
	        <c:choose>
				...
				<c:when test="${sessionScope.roletype == 'ADMIN' }">
					...
					<li><a href="adminInfo" style=" font-size:20px; color:black; text-decoration:none; margin-right:25px;">마이페이지</a></li><li><a href="logout" style=" font-size:20px; color:black; text-decoration:none; margin-right: 400px;">로그아웃</a></li>
				</c:when>
	...
	<br><br><br><br><br><br>
		...
		<form action="selectSearchList" method="post">
			...
			<input type="text" id="mySearch" name="search" style="height: 45px" onkeyup="myFunction()" placeholder="검색.." title="Type in a category">
...
<!-- 2.index -->
	      ...
	      <div id ="bbb"class="content"><h1></h1></div> 
...
<!-- 3.index -->      
      ...
      <form name="form44" action="contactSave">
	      ...
	      <img src="C:\springworks\test20\src\main\webapp\views\image\쥐도.PNG">
	    </div>  
	      <div style="margin-left: 60%; margin-top: -40%;">	
	     			<strong><p>이름</p></strong><input type="text" name="name"><br><br>
	      			...
	      			<strong><p>내용</p></strong><textarea type="text" name="message" rows="3" cols="50"></textarea>
	    			 <p><button  class="btn btn-primary pull-right"  onclick="form44.submit()">문의하기
	      	</button>
	     </div> 	
...
<script>
	...
	var url = "findId";
	var name = "findId";
	var option = "width = 800, height = 400, top = 100, left = 600, location = no";
