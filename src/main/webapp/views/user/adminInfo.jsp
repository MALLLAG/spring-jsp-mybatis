...
<div class="container" style="text-align: left;">
		...
		<div style="margin-left: 23%; margin-top:7%; ">
   		...
   		<input type="hidden" name="userno" value="<c:out value="${sessionScope.userno}"/>"> 
			<a class="btn btn-info" href="updateForm" style="text-decoration:none; color:white; ">회원정보 수정</a>
			<a class="btn btn-success" href="#" type="submit" onclick="form5.submit()" style="text-decoration:none; color:white;">쪽지함</a>
